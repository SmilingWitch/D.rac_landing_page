        ...
        <div  className="w-full flex  justify-between bg-[#121314] p-[100] h-[100vh]">
            <div className="p-[30] w-[40%] gap-10 flex flex-col">
                <div className="w-full flex justify-center pb-5 text-[2.5rem]">
                    <h2 className="shadow-xl/20 shadow-[#FFFF00] rounded-[10]">Become a pilot user!</h2>
                </div>
                <div>
                    <span className="text-[2rem] pb-5">
                ...
                <div>
                    <span className="text-[2rem]">Enjoy Exclusive Rewards</span>
            ...
            <div className="p-20 relative flex items-center justify-start ">
                <div className="absolute w-[400] h-[500] flex flex-col justify-between pl-[20]">
                    <span className="text-[1.2rem]">Pilot User spots are limited and will be assigned on a first-come, first-served basis.</span>
                    <div className="flex flex-col gap-[4] items-start">
                        <span className="text-[2rem]">Register now and secure your spot in this select club!</span>
                        <button className="bg-[#FFFF00] pl-5 pr-5 pt-3 pb-3  text-black rounded-[5] cursor-pointer">Subscribe</button>
                    </div>
                </div>
